...
Invoke-WebRequest -Uri "https://github.com/abbodi1406/WHD/raw/refs/heads/master/scripts/OfficeScrubber_13.zip" -OutFile "C:\Windows\Temp\OfficeScrubber_13.zip"
