...
Dim fx86Only        : fx86Only = False
Dim fx64Only        : fx64Only = False
                    ...
                    For Each sProductCode in Split(sProductCodeList, Chr(34))
                        If Len(sProductCode) = 38 Then
                            ...
                            Else
                                ...
                                'Case "000F", "0011", "0012", "0013", "0014", "002E", "002F", "0030", "0031", "0033", "0035", "003D", "0061", "0062", "0066", "0074", "00CA", "0100"
    ...
    If Len(sProductCode) = 38 Then
        ...
        Case "15"
            If Right(sProd, PRODLEN) = OFFICEID AND Mid(sProd, 4, 2) = OVERSIONMAJOR Then 
                ...
                Case Else
                    If Mid(sProd, 21, 1) = "1" Then fIsX86 = False
                    If fx86Only Then
                        If fIsX86 Then fInScope = True
                    ElseIf fx64Only Then
                        If NOT fIsX86 Then fInScope = True
                    Else
                        fInScope = True
                    End If
                End Select
...
'   LogOnly
'
'   Echos the log string to the log file
'-------------------------------------------------------------------------------
Sub LogOnly (sLog)
    If sLog = "" Then
        LogStream.WriteLine
