...
Sub RegWipeWIPublishedComponents (hDefKey, sSubKeyName)
    Dim Item, Name, value
    Dim sValue, sGuid
    Dim i
    Dim arrNames, arrTypes, arrMultiSzValues, arrMultiSzNewValues
    Dim arrTestNames, arrTestTypes, arrKeys
    Dim fDelReg
...
End Sub 'RegWipeWIPublishedComponents
...
Sub CloseOfficeApps
    ...
    'Avoid to error out before loop completes
    On Error Resume Next
...
Sub ParseCmdLine
    ...
    For iCnt = 0 To UBound(arrArguments)
        ...
        Case "/DOM","/DISABLEORPHANMODE","/DISABLEORPHANSMODE"
            fNoOrphansMode = True

        Case "/DRONC","/DONTRUNONCLEAN"
            fRunOnVanilla = False
