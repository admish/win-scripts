...
' Copyright (c) 2008-2015 Microsoft Corporation
    ...
    If RegEnumKey(HKLM, REG_ARP, arrKeys) Then
        For Each ArpItem in arrKeys
            ...
            If (fPackages AND fDisplayVersion) Then
                If InStr(ArpItem, ".") > 0 AND (NOT Left(ArpItem, 5) = "OMUI.") Then sConfigName = UCase(Mid(ArpItem, InStr(ArpItem, ".") + 1)) Else sConfigName = UCase(ArpItem)
    ...
    If Len(sProductCode) = 38 Then
        ...
        Case "12"
            If Right(sProd, PRODLEN) = OFFICEID AND Mid(sProd, 4, 2) = OVERSIONMAJOR Then 
                ...
                Case "0070"
                    If fRemoveVBA Then fInScope = True
                Case Else
                    fInScope = True
                End Select
            End If
...
Function GetProductID(sProdID)
        ...
        Case "0122" : sReturn = "OLC" 'Outlook Connector
